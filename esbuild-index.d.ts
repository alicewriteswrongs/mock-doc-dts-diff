...
declare function cloneAttributes(
  srcAttrs: MockAttributeMap,
  sortByName?: boolean,
): MockAttributeMap;
...
declare function setStyleElementText(
...
declare function createCustomElement(
...
declare function attributeChanged(
  node: MockNode,
  attrName: string,
...
declare function createElementNS(
  ownerDocument: any,
  namespaceURI: string,
  tagName: string,
): any;
...
declare class MockElement extends MockNode {
  ...
  getRootNode(opts?: { composed?: boolean; [key: string]: any }): Node;
  get draggable(): boolean;
  set draggable(value: boolean);
...
declare function parseHtmlToDocument(
  html: string,
  ownerDocument?: MockDocument,
): any;
declare function parseHtmlToFragment(
  html: string,
  ownerDocument?: MockDocument,
): any;
 ...
 */
declare function serializeNodeToHtml(
  elm: Node | MockNode,
